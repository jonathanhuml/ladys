...
def test_mint_nlb_experiment_configs_load():
    ...
    assert [config.model.dataset for config in configs] == ["area2_bump", "dmfc_rsg", "mc_maze", "mc_rtt"]
    assert [config.model.train_source for config in configs] == ["nwb", "nwb", "nwb", "mat"]
