...
from cassm.utils.gpfa_utils.kernel import Kernel
from cassm.utils.gpfa_utils import funcs
from cassm.utils.gpfa_utils import utilities
...
def draw_samples(d, k, t, tmax, kern, seed = 0):
    ...
    yknt = utilities.sample(Kxx, k).reshape([k, d, -1])
    return yknt, xt
